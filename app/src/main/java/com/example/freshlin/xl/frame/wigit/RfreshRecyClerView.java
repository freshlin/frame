 ...
 */
public abstract class RfreshRecyClerView extends ViewGroup implements NestedScrollingParent{
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        for(int i = 0; i < getChildCount(); ++i){
            ...
            if(i == 0){
                ...
                view.layout(0, 0, childW, childH);
                if(recyclerView == null)recyclerView = (RecyclerView) view;
            }else{
                if(bottomView == null)bottomView = view;
